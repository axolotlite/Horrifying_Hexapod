...
//link
//{current angle, starting angle, min, max, pin}

// static LIMB *legs[6] = {&leg1, &leg2, &leg3, &leg4, &leg5, &leg6};
//will need to manually calculate safety angles
static LIMB legs[6] = {
    {   //first limb
        initialPoint,{93,93,25,100,0},{81,81,25,100,1},{81,81,25,100,2}
    },
    {   //second limb
        initialPoint,{93,93,25,100,3},{94,94,25,100,4},{81,81,25,100,5}
    },
    {   //third limb
        initialPoint,{86,86,25,100,6},{84,84,25,100,7},{97,97,25,100,8}
    },
    {   //fourth limb
        initialPoint,{93,93,25,100,9},{84,84,25,100,10},{85,85,25,100,11}
    },
    {   //fifth limb
        initialPoint,{95,95,25,100,12},{93,93,25,100,13},{94,94,25,100,14}
    },
    {   //sizth limb
        initialPoint,{86,86,25,100,A0},{91,91,25,100,A1},{98,98,25,100,15}
    }
};
...
static void motionCoreInit(){
    leg6Coxa.attach(legs[5].coxa.pin);
    leg6Femur.attach(legs[5].femur.pin);
...
static void updateAngles(){
    ...
    PWM_Driver.writeMicroseconds(legs[0].femur.pin,PWM_2_DEGREE(legs[0].femur.angle));
    PWM_Driver.writeMicroseconds(legs[0].tibia.pin,PWM_2_DEGREE(legs[0].tibia.angle));

    PWM_Driver.writeMicroseconds(legs[1].coxa.pin, PWM_2_DEGREE(legs[1].coxa.angle));
    PWM_Driver.writeMicroseconds(legs[1].femur.pin,PWM_2_DEGREE(legs[1].femur.angle));
    PWM_Driver.writeMicroseconds(legs[1].tibia.pin,PWM_2_DEGREE(legs[1].tibia.angle));

    PWM_Driver.writeMicroseconds(legs[2].coxa.pin, PWM_2_DEGREE(legs[2].coxa.angle));
    PWM_Driver.writeMicroseconds(legs[2].femur.pin,PWM_2_DEGREE(legs[2].femur.angle));
    PWM_Driver.writeMicroseconds(legs[2].tibia.pin,PWM_2_DEGREE(legs[2].tibia.angle));

    PWM_Driver.writeMicroseconds(legs[3].coxa.pin, PWM_2_DEGREE(legs[3].coxa.angle));
    PWM_Driver.writeMicroseconds(legs[3].femur.pin,PWM_2_DEGREE(legs[3].femur.angle));
    PWM_Driver.writeMicroseconds(legs[3].tibia.pin,PWM_2_DEGREE(legs[3].tibia.angle));

    PWM_Driver.writeMicroseconds(legs[4].coxa.pin, PWM_2_DEGREE(legs[4].coxa.angle));
    PWM_Driver.writeMicroseconds(legs[4].femur.pin,PWM_2_DEGREE(legs[4].femur.angle));
    PWM_Driver.writeMicroseconds(legs[4].tibia.pin,PWM_2_DEGREE(legs[4].tibia.angle));

    leg6Coxa.write(legs[5].coxa.angle);
    leg6Femur.write(legs[5].femur.angle);
    PWM_Driver.writeMicroseconds(legs[5].tibia.pin,PWM_2_DEGREE(legs[5].tibia.angle));
    if(updateAnglesFlag){
